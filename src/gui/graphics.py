...
class Graphics(QWidget):
    ...
    def initUI(self):
        ...
        self.btnce.setStyleSheet("background-color: silver")
        self.btnadd.setStyleSheet("background-color: silver")
        self.btnsub.setStyleSheet("background-color: silver")
        self.btnmul.setStyleSheet("background-color: silver")
        self.btndiv.setStyleSheet("background-color: silver")
        self.btnLbracket.setStyleSheet("background-color: silver")
        self.btnRbracket.setStyleSheet("background-color: silver")
        self.btnc.setStyleSheet("background-color: silver")
        self.btnabs.setStyleSheet("background-color: silver")
        self.btnsqrt.setStyleSheet("background-color: silver")
        self.btnneg.setStyleSheet("background-color: silver")
        self.btnpow.setStyleSheet("background-color: silver")
        self.btneq.setStyleSheet("background-color: silver")
